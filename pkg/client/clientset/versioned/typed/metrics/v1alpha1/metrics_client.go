...
import (
	v1alpha1 "github.com/bbaobelief/k8s-falcon-metrics-adapter/pkg/apis/metrics/v1alpha1"
	"github.com/bbaobelief/k8s-falcon-metrics-adapter/pkg/client/clientset/versioned/scheme"
...
// MetricsV1alpha1Client is used to interact with features provided by the metrics.falcon group.
type MetricsV1alpha1Client struct {
	restClient rest.Interface
}

func (c *MetricsV1alpha1Client) CustomMetrics(namespace string) CustomMetricInterface {
