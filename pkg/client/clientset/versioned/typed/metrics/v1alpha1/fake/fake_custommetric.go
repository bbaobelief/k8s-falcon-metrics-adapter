...
var custommetricsResource = schema.GroupVersionResource{Group: "metrics.falcon", Version: "v1alpha1", Resource: "custommetrics"}

var custommetricsKind = schema.GroupVersionKind{Group: "metrics.falcon", Version: "v1alpha1", Kind: "CustomMetric"}
